...
export const MobileCitySelection = () => {
  ...
  return (
    <div
      className="sm:flex flex-col items-center justify-center lg:hidden sm: w-max h-max ml-10"
      style={{
    ...
    >
      <h1 className="sm:font-bold text-3xl text-white text-center p-10 mt-4 ml-10 rounded-md backdrop-blur bg-white/30">
        Welcome to GamePlay!
      </h1>
      <form action="">
